...
async def platform_dashboard(request: Request):
    ...
    calendar_recommendations = (
        get_platform_calendar_incident_analytics(days=30)[
            "recommendations"
        ][:3]
    )
...
@app.get("/calendar/dispatch", response_class=HTMLResponse)
...
@app.post("/api/calendar/day/acknowledgements/remind")
...
@app.post("/api/calendar/dispatch/plan/apply")
...
@app.post("/api/calendar/dispatch/move")
